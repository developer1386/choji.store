...
function App() {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-orange-50 to-green-50">
      ...
      <section className="pt-24 pb-16 px-4" role="banner">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <p className="text-xl text-gray-600 mb-8 max-w-2xl mx-auto leading-relaxed">
            Made with love from fresh chicken, wholesome potatoes, and
            nutritious carrots. Give your feline friend the natural,
            preservative-free nutrition they deserve.
          </p>
          ...
          <div className="grid md:grid-cols-2 gap-12 items-center">
            ...
            <div>
              <p className="text-lg text-gray-700 leading-relaxed mb-6">
                Choji was a beloved family cat who inspired us to create the
                healthiest, most natural cat food possible. After struggling to
                find quality commercial options that met our high standards, we
                decided to make our own.
              </p>
              <p className="text-lg text-gray-700 leading-relaxed">
                Every batch is carefully prepared in small quantities using only
                the finest ingredients: premium chicken, organic potatoes, and
                fresh carrots. No preservatives, no fillers, no compromises—just
                pure, wholesome nutrition that cats love and owners trust.
              </p>
            </div>
          </div>
        </div>
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8">
            <div className="bg-white p-8 rounded-2xl shadow-lg hover:shadow-xl transition-shadow text-center">
              ...
              <p className="text-gray-600">
                Premium chicken as the main protein source, rich in essential
                amino acids.
              </p>
            </div>
            <div className="bg-white p-8 rounded-2xl shadow-lg hover:shadow-xl transition-shadow text-center">
              ...
              <p className="text-gray-600">
                Organic potatoes and carrots provide natural vitamins and fiber
            ...
            <div className="bg-white p-8 rounded-2xl shadow-lg hover:shadow-xl transition-shadow text-center">
              ...
              <p className="text-gray-600">
                Zero preservatives, artificial colors, or fillers. Just pure,
                natural ingredients.
              </p>
            </div>
            <div className="bg-white p-8 rounded-2xl shadow-lg hover:shadow-xl transition-shadow text-center">
              ...
              <p className="text-gray-600">
                Every batch is lovingly prepared in small quantities for maximum
                freshness.
              </p>
            </div>
          </div>
        ...
        <div className="max-w-4xl mx-auto">
          <div className="text-center mb-12">
            ...
            <p className="text-lg text-gray-600">
              Choose the perfect size for your feline friend
            </p>
          </div>
          <div className="grid md:grid-cols-3 gap-8">
            <div className="bg-gradient-to-br from-orange-50 to-orange-100 p-8 rounded-2xl border-2 border-transparent hover:border-orange-200 transition-all">
              <div className="text-center">
                ...
                <p className="text-gray-600 mb-4">
                  Perfect for trying out or single cats
                </p>
            ...
            <div className="bg-gradient-to-br from-green-50 to-green-100 p-8 rounded-2xl border-2 border-green-200 transform scale-105 relative">
              ...
              <div className="text-center">
                ...
                <p className="text-gray-600 mb-4">
                  Great value for regular feeding
                </p>
            ...
            <div className="bg-gradient-to-br from-blue-50 to-blue-100 p-8 rounded-2xl border-2 border-transparent hover:border-blue-200 transition-all">
              <div className="text-center">
                ...
                <p className="text-gray-600 mb-4">
                  Best value for big and multiple cats
                </p>
      ...
      <section
        id="order-form"
        className="py-16 px-4 bg-gradient-to-br from-orange-50 to-green-50"
      >
        <div className="max-w-2xl mx-auto">
          <div className="text-center mb-12">
            ...
            <div className="w-24 h-1 bg-orange-500 mx-auto mb-8"></div>
            <p className="text-lg text-gray-600">
              Ready to give your cat the best? Let's get started!
            </p>
          </div>
          <form
          ...
          >
            ...
            <p className="text-sm text-gray-500 text-center mt-4">
              We'll contact you via WhatsApp to confirm your order and arrange
              delivery
            </p>
          </form>
        </div>
          ...
          <div className="grid md:grid-cols-3 gap-8 text-center md:text-left">
            <div>
              ...
              <p className="text-gray-400">
                Premium homemade cat food made with love and natural
                ingredients.
              </p>
            </div>
            <div>
